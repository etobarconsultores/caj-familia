...
import { hashearPin, compararPin, formatoPinValido, iniciarIntentoPin, reiniciarIntentosPin } from '../pin.js';
import { minutosRestantesDesde } from '../throttle.js';

export async function pinChange(req, res, usuario) {
  try {
    ...
    // antes de comparar nada -- mismo modelo que credentials.reveal.
    let reserva;
    try {
